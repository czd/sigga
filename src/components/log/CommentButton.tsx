	...
	return (
		<>
			<button
				...
				className="inline-flex min-h-9 items-center gap-1 rounded-md px-1.5 text-sm text-ink-soft transition-colors hover:bg-paper-deep/40 focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring"
			>
