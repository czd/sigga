...
export function ReglulegirView() {
	...
	return (
		<div className="px-4 py-6 pb-28 flex flex-col gap-6">
			<Link
				href="/timar"
				className="inline-flex items-center gap-1 rounded-md text-sm text-ink-faint transition-colors outline-none hover:text-ink-soft focus-visible:ring-2 focus-visible:ring-ring/50"
			>
