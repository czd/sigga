...
export default convexAuthNextjsMiddleware(
	...
	// Persistent cookies — without this, Convex Auth uses session cookies which
	// iOS clears when the standalone PWA is closed, forcing a re-login on every
	// open. 30 days lines up with Convex Auth's default session window.
	{ cookieConfig: { maxAge: SESSION_DURATION_SECONDS } },
);
